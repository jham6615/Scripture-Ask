...
/** Privacy policy hosted on GitHub Pages (github.com/jham6615/beacon-bible-site → GitHub Pages). */
...
/** Public support page hosted on GitHub Pages (github.com/jham6615/beacon-bible-site → GitHub Pages). */
